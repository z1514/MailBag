...
// Render the UI.
const baseComponent = ReactDOM.render(<BaseLayout />, document.body);//styles are binded here
...
getMailboxes().then(function() {
  ...
  getContacts().then(() => baseComponent.state.showHidePleaseWait(false));//this is a chain
});
